...
?>
<section class="content" id="arthik_barsa">
    ...
    <div class="container-fluid ">
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-4 shade_box">

                        <div class="form-group">
                            <label class="label_txt">आर्थिक वर्ष</label>
                    ...
                    <div class="col-md-4 shade_box">
                        ...
                        <div class="form-group">
                            <label class="label_txt">हालको आर्थिक वर्ष:<?= $current_session->name ?></label>
                        </div>
                        <div class="form-group">
                            <button type="button" class="btn btn-info btn-lg btn_round" data-toggle="modal"
                                data-target="#myModal">अहिलेको
                                आर्थिक वर्ष छान्नुहोस्</button>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
            ...
            <div class="box box-primary" style="margin-left: 10px">
                <div class="box-header with-border">
                    <center>
                        <h4 class="box-title mb-3">आर्थिक वर्षहरु</h4>
                    </center>
                </div>
