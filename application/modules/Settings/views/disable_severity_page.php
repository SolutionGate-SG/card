...
?>
<section class="content" id="disable_severity_page">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3 shade_box">
                    <div class="form-group">
                        <label class="label_txt">अपाङ्गको गम्भिरता (नेपाली)</label>
                        <input type="text" name="name" class="form-control "
                            value="<?php if(isset($result->name)){ echo $result->name;}?>" required>
                    </div>
                    <div class="form-group">
                        <label class="label_txt">अपाङ्गको गम्भिरता (English)</label>
                    ...
                    <div class="form-group">
                        <label class="label_txt">वर्ग</label>
                        <input type="text" name="group" class="form-control "
                            value="<?php if(isset($result->group)){ echo $result->group;}?>" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="box box-primary" style="margin-left: 10px">
                <div class="box-header with-border">
                    <center>
                        <h4 class="box-title">अपाङ्गको गम्भिरताको किसिम</h4>
                    </center>
                </div>
