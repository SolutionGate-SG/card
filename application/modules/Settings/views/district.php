...
?>
<section class="content" id="district_page">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3 shade_box">
                    <div class="form-group">
                        <label class="label_txt">जिल्लाको नाम (नेपाली)</label>
                        <input type="text" name="name" class="form-control "
                            value="<?php if(isset($result->name)){ echo $result->name;}?>" required>
                    </div>
                    <div class="form-group">
                        <label class="label_txt">जिल्लाको नाम (English)</label>
            ...
            <div class="box box-primary" style="margin-left: 10px">
                <div class="box-header with-border">
                    <center>
                        <h4 class="box-title">जिल्लाहरु</h4>
                    </center>
                </div>
