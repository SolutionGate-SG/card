        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3" >
                    ...
                    <div class="form-group">
                        <label>पद (नेपाली) </label>
                        <input type="text" name="post" class="form-control " value="<?php if(isset($result->post)){ echo $result->post;}?>" required>
                    </div>
                    <div class="form-group">
                        <label>पद (English) </label>
                        <input type="text" name="english_post" class="form-control " value="<?php if(isset($result->english_post)){ echo $result->english_post;}?>" required>
                    </div>
                    <div class="form-group">
                        <label>कार्यालय</label>
                        <input type="text" name="office" class="form-control " value="<?php if(isset($result->office)){ echo $result->office;}?>" required>
                    </div>
                    <div class="form-group">
            ...
            <div class="box box-primary"  style="margin-left: 10px">
                <div class="box-header with-border">
                    <center><h4 class="box-title">प्रमाणित गर्नेहरु</h4></center>
                </div>
