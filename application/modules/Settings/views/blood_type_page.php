...
if(isset($result))
{
    $action_page = base_url()."edit-blood-type/".$result->id;
}
else
{
    $action_page = base_url()."add-blood-type";
}

?>
<section class="content" id="blood_type">
    ...
    <div class="container-fluid ">
        <nav aria-label="breadcrumb" class="bg-shadow">
            <ol class="breadcrumb px-3 py-2 bread-list">
                ...
                <li class="breadcrumb-item active">रक्त समूह</li>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="col-12 col-md-6 offset-md-3 shade_box">
                    <div class="form-group">
                        <label class="label_txt">रक्त समूह</label>
            ...
            <div class="box box-primary" style="margin-left: 10px">
                <div class="box-header with-border">
                    <center>
                        <h4 class="box-title">रक्त समूहहरु</h4>
                    </center>
                </div>
                <table id="table1" class="table table_style">
                    ...
                    foreach ($blood_types as $type){
                        ...
                        <tr>
                            ...
                            <td><?=$type->name?></td>
                            <!-- <td>
                                <a href="<?=base_url()?>edit-blood-type/<?=$type->id?>">
                                    <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                </a>&nbsp;&nbsp;
                                <a href="<?=base_url()?>blood-type/<?=$type->id?>">
