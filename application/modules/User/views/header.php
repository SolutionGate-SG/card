...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>assets/dist/scss/main.css">
...
<body style="background:white;" class='  ls-opened  theme-violet '>
    ...
    <div class="page-wrapper">
        <nav class="navbar navbar-expand-lg navbar-dark bg-deep-blue">
            ...
            <img alt="logo" src="<?=base_url()?>assets/images/icons/logo.png" class="img-responsive ml-3"
                height="50px;">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        <a style="color:white;" class="nav-link dropdown-toggle user" href="#" id="navbarDropdown"
                    ...
                    <ul class='list'>
                        ...
                        <li id="save-disable-detail">
                            <a href="<?= base_url()?>save-disable-detail">
                                <span> <i class="fa fa-plus sidebar-icon"></i>अपाङ्गता व्यक्ति थप्नुहोस
                                </span>
                            </a>
                        </li>
