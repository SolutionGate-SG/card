                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                            <input type="text" name="name" class="form-control"
                                                                placeholder="Full Name" required id="id_name" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                            <input type="text" name="phone" class="form-control"
                                                                placeholder="Phone Number" required id="id_phone" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                            <input type="text" name="address" class="form-control"
                                                                placeholder="Address" required id="id_address" />
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                            <select name="mode" id="id_mode" class="form-control"
                                                                required>
                                                    ...
                                                    <div class="form-group col-md-6 ">
                                                        <div class="input-group input-group-sm">
                                                            <input type="password" name="repassword"
                                                                ...
                                                                required id="id_repassword" />
                                                            <span id="right" class="fa fa-check"
                                                                style="display:none;color:green;"></span>
                                                            <span id="wrong" class="fa fa-times"
                                                                style="display:none;color:red;"></span>
                                                        </div>
                                                    </div>
                                                </div <div class="form-group mt-2 col-md-12">
                                                <button class="btn btn-success btn-sm btn-block btn_round" name="submit"
                                                    type="submit">
                                                    Sign Up
                                                </button>
