                                        ...
                                        <div class="id-body">
                                            ...
                                            <div class="row">
                                                <div class="col">प. प. प्रकार: <span
                                                        class="input-padder"><?= $disability_severity->group?></span>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">नाम थर: <span
                                                        class="input-padder"><?= $result->nepali_name ?></span></div>
                                            </div>
                                            <div class="row">
                                        ...
                                        <div class="idcard-back">
                                            <div class="row">
                                                <div class="col">1) Name of Id Holder: <span
                                                        class="input-padder"><?= $result->english_name ?></span></div>
                                            </div>
                                            <div class="row">
