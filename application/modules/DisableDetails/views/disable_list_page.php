           ...
           <div class="card-body">
               ...
               <div class="row">
                   <div class="col-md-4">
                       <div class="form-group row">
                           <label class="col-sm-2 col-form-label"><span
                                   class="float-right">नाम</span></label>
                           <div class="col-sm-10">
                               <div class="input-group">
                                  <input type="text" class="form-control" name="p_name" id='p_name' value="<?= isset($this_name) ? $this_name : ''?>">
                               </div>
                           </div>
                       </div>
                   </div>
                   <div class="col-md-3">
                       <div class="form-group row">
                           <label class="col-sm-4 col-form-label"><span
                                   class="float-right">प.प.नं.</span></label>
                           <div class="col-sm-8">
                               <div class="input-group">
                                  <input type="number" class="form-control" name="pp_no" id='pp_no' value="<?= isset($this_pp_no) ? $this_pp_no : ''?>">
                               </div>
                           </div>
                       </div>
                   </div>
                   <div class="col-md-5">
                       <div class="form-group row">
                           <label class="col-sm-4 col-form-label"><span
                                   class="float-right">अपाङ्गताको प्रकृति</span></label>
                           <div class="col-sm-8">
                               <div class="input-group">
                 ...
                 <div class="col-md-4">
                     <div class="form-group row">
                         <label class="col-sm-4 col-form-label"><span
                                 class="float-right">अपाङ्गताको गम्भीरता</span></label>
                         <div class="col-sm-8">
                             <div class="input-group">
                 ...
                 <div class="col-md-2">
                     <div class="form-group row">
                         <label class="col-sm-4 col-form-label"><span
                                 class="float-right">वडा</span></label>
                         <div class="col-sm-8">
                             <div class="input-group">
                ...
                <div class="mt-3">
                    <div class="row">
                        <h4 class="col-md-9">अपाङ्गता व्यक्तिको सुची</h4>
                         <div class="col-md-3 row mb-3">
                             <?php echo form_open(base_url().'convert-to-Excel/disable_export_page/Disable_Details_Report', 'target="_blank"');?>
                                 <input type="hidden" name="pp_no" id='p_pp_no' value="<?= isset($this_pp_no) ? $this_pp_no : ''?>">
                                 <input type="hidden" name="disable_type" id='p_disable_type' value="<?= isset($this_disable_type) ? $this_disable_type->id : ''?>">
                                 <input type="hidden" name="disable_severity" id='p_disable_severity' value="<?= isset($this_disable_severity) ? $this_disable_severity->id : ''?>">
                                 <input type="hidden" name="ward" id='p_ward' value="<?= isset($this_ward) ? $this_ward : ''?>">
                                 <button type="submit" name="button" class="btn btn-secondary mr-2"><i class="fa fa-file-excel-o"></i> Export</button>
                             <?php echo form_close(); ?>
                             <?php echo form_open(base_url().'print-preview'); ?>
                             <button type="submit" name="print" class="btn btn-success"><i class="fa fa-print"></i> प्रिन्ट गर्नुहोस्</button>
                         </div>
                    </div>
                    ...
                    <?php if ($disable_details != FALSE): ?>
                        <?php $i = 1; foreach($disable_details as $detail): ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url()?>disable-details/<?= $detail->id?>"><i class="fa fa-eye"></i></a>
                                    <a href="<?= base_url()?>edit-disable-detail/<?= $detail->id?>"><i class="fa fa-edit"></i></a>
                                </td>
                            </tr>
                        <?php $i++; endforeach; ?>
                    <?php else:?>
