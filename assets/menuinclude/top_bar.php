<nav class="navbar navbar-guest navbar-expand-lg navbar-dark bg-deep-blue">
    ...
    <img alt="logo" src="dist/images/logo_0.png" class="img-responsive ml-3" height="50px;">
        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="/users/login/"> <i class="fa fa-sign-in"></i>&nbsp; Log In</a>
                </div>
            </li>
